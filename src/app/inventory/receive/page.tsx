    ...
    return (
        <main className="max-w-2xl mx-auto p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-xl font-bold">Receive Stock (Penerimaan Barang)</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white border rounded-lg p-6 space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        className="w-full border rounded px-3 py-2 text-sm"
                        placeholder="PO-12345, DO-001, dll"
                    />
                </div>
                ...
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2 text-center text-sm">
                        ...
                        <div className="bg-white border rounded p-2">
                            ...
                            <p className="text-lg font-bold text-green-600">+{result.stockAfter - result.stockBefore}</p>
                        </div>
                        <div className="bg-white border rounded p-2">
                            <p className="text-gray-500">Stok Sekarang</p>
                            <p className="text-lg font-bold text-green-700">{result.stockAfter}</p>
                        </div>
                    </div>
