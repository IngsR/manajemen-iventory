...
import { transferStockAction } from '@/actions/TransferStockAction';
    ...
    return (
        <main className="max-w-2xl mx-auto p-6">
            <div className="flex items-center gap-3 mb-6">
                ...
                <h1 className="text-xl font-bold">Transfer Stock (Pindah Lokasi)</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white border rounded-lg p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select name="sourceLocationId" required className="w-full border rounded px-3 py-2 text-sm">
                    ...
                    <div>
                        ...
                        <select name="destinationLocationId" required className="w-full border rounded px-3 py-2 text-sm">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        className="w-full border rounded px-3 py-2 text-sm"
                        placeholder="TRF-001, dll"
                    />
                </div>

                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Keterangan</label>
                    <input name="reason" type="text" className="w-full border rounded px-3 py-2 text-sm" placeholder="Opsional" />
                </div>
                ...
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2 text-center text-sm">
                        <div className="bg-white border rounded p-2">
                            <p className="text-gray-500">Stok Asal Sebelum</p>
                            <p className="text-lg font-bold">{result.stockAtSource.before}</p>
                        </div>
                        <div className="bg-white border rounded p-2">
                            <p className="text-gray-500">Dipindah</p>
                            <p className="text-lg font-bold text-blue-600">{result.stockAtSource.before - result.stockAtSource.after}</p>
                        </div>
                        <div className="bg-white border rounded p-2">
                            <p className="text-gray-500">Stok Asal Sekarang</p>
                            <p className="text-lg font-bold text-blue-700">{result.stockAtSource.after}</p>
                        </div>
                    </div>
