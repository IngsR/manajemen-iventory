...
export default function ReceivePage() {
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[300px] text-xs text-slate-500">
                ...
                <span>Memuat data master penerimaan...</span>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto animate-fade-in">
            <PageHeader
                title="Penerimaan Barang (Inbound Receive)"
                subtitle="Catat pemasukan stok fisik dari supplier atau produksi ke lokasi gudang penyimpanan."
            ...
            <FormCard
                title="Formulir Penerimaan Barang Masuk"
                description="Pastikan fisik barang dan dokumen surat jalan / PO telah diperiksa sebelum input."
                icon={PackageCheck}
                footer={
                    <Button
                        type="submit"
                ...
                <form id="receive-form" onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <Label htmlFor="rcv-item">Komoditas Barang (SKU) *</Label>
                            <select
                                id="rcv-item"
                                name="itemId"
                                required
                        ...
                        <div className="space-y-1.5">
                            <Label htmlFor="rcv-loc">Titik Lokasi Gudang Tujuan *</Label>
                            <select
                                id="rcv-loc"
                                name="locationId"
                                required
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <Label htmlFor="rcv-qty">Jumlah Kuantitas Masuk *</Label>
                            <Input
                                id="rcv-qty"
                                name="quantity"
                                type="number"
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="rcv-reason">Keterangan / Catatan Fisik</Label>
                        <Input
                            id="rcv-reason"
                            name="reason"
                            type="text"
                            placeholder="Kondisi barang baik, segel utuh..."
                            className="text-xs h-9 rounded-xl"
                        />
                    </div>
                </form>
            ...
            {result && (
                <Card className="glass-card border-emerald-200/80 bg-emerald-50/40 p-5 shadow-sm animate-scale-in">
                    <CardContent className="p-0 space-y-4">
                        <div className="flex items-center gap-2.5 text-emerald-800">
                            <CheckCircle2 className="h-5 w-5 text-emerald-600 shrink-0" />
                            <div>
                                <h3 className="text-sm font-bold tracking-tight">Transaksi Penerimaan Berhasil</h3>
                        ...
                        <div className="grid grid-cols-3 gap-3 text-center">
                            ...
                            <div className="bg-white/90 border border-emerald-200 rounded-xl p-3 shadow-xs">
                                <span className="text-[10px] font-semibold uppercase text-emerald-600">Diterima (+)</span>
                        ...
                        <div className="flex items-center justify-between text-[11px] text-slate-500 pt-2 border-t border-emerald-100">
                            ...
                            <span className="text-emerald-700 font-medium">Tercatat di StockBalance &amp; Audit Log</span>
                        </div>
                    </CardContent>
                </Card>
            )}
