...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[9rem] overflow-hidden rounded-2xl border border-slate-200/70",
      "bg-white p-1.5",
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-slate-200/70 bg-white p-1.5",
        "shadow-[0_8px_32px_rgba(15,23,42,0.12),_0_2px_8px_rgba(15,23,42,0.06)]",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "px-3 py-2.5 text-sm font-medium text-slate-700 outline-none",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-lg py-2.5 pl-9 pr-3",
      "text-sm font-medium text-slate-700 outline-none",
      "focus:bg-slate-100 focus:text-slate-900",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "transition-colors duration-100",
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto text-xs font-medium tracking-widest text-slate-400", className)}
      {...props}
    />
  )
}
